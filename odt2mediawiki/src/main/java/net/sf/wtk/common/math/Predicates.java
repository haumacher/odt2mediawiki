...
public class Predicates {
	...
	public static <T> Predicate<T> and(final Predicate<T>... ps) {
		...
		case 0: return TRUE();
		case 1: return ps[0];
		case 2: return new And2<T>(ps[1], ps[0]);
		case 3: return new And3<T>(ps[0], ps[1], ps[2]);
		default: return new AndN<T>(cnt, ps);
		}
	}
	...
	public static <T> Predicate<T> or(final Predicate<T>... ps) {
		...
		case 0: return FALSE();
		case 1: return ps[0];
		case 2: return new Or2<T>(ps[1], ps[0]);
		case 3: return new Or3<T>(ps[0], ps[1], ps[2]);
		default: return new OrN<T>(cnt, ps);
		}
	}
